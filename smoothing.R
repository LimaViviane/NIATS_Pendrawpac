...
# 
# Description:
#     A function that receives a data frame collected through TREMSEN 
#     and smooths the signals from accelerometer 1 and 2. Although the 
#     collected with TREMSEN have the magnetorometer and gyroscope sensors,
#     this function is configured to remove trends only from the signals from accelerometers 1 and 2.
# 
# Input:
#      df: dataframe resulting from removeSpikes.
#
# Output:
#       A data frame with the signals of accelerometers 1 and 2 without noise. 
#
# Example of use:
#
#       df.smoothing <- smoothing(df)
#
